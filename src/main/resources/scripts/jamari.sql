...
Insert into ORDERS (ID,RESTAURANT_ID,BEGIN_TIME,END_TIME,END_MONEY,MEMBER_ACCOUNT,STATUS,INFO,RESTAURANT_NAME) values (125,3,to_timestamp('13-Jun 2016 09.57.05 PM','DD-MON-YYYY HH.MI.SS AM'),to_timestamp('13-Jun 2017 10.56.00 PM','DD-MON-YYYY HH.MI.SS AM'),99999,'admin','進行中',null,'二男小家料理');
...
Insert into CUSTOMER(ID,ITEM_ID,MEMBER_ACCOUNT,COUNTS,MONEY,C_DATE,STATUS,ORDER_ID)values(1,2,'admin',1,360,to_timestamp('02-Sep -2016 01.13.21 PM','DD-MON-YYYY HH.MI.SS AM'),'未取餐','125');
Insert into M_ORDER(MEMBER_ACCOUNT,ORDER_ID,JOIN_DATE )values('admin',125,to_timestamp('02-Sep -2016 01.13.20 PM','DD-MON-YYYY HH.MI.SS AM'));
